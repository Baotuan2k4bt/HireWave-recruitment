...
const Profile = () => {
    ...
    const profileAvatarSrc = useMemo(() => {
        ...
        if (!rawPicture) return "/avatar.png";
        ...
        <div className=" " >
            <div data-aos="zoom-out" className="relative px-5">
                ...
                <div  ref={ref} className="absolute cursor-pointer flex items-center justify-center !rounded-full -bottom-1/3  md-mx:-bottom-10 sm-mx:-bottom-16  left-6">
                        ...
                        <Avatar
                            className="!w-48  !h-48 md-mx:!w-40 md-mx:!h-40 border-deepSlate-950 border-8  rounded-full sm-mx:!w-36 sm-mx:!h-36 xs-mx:!h-32 xs-mx:!w-32"
