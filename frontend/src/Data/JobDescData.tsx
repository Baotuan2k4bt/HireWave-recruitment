...
const card=[
    {name:"Địa điểm", icon:IconMapPin, value:"New York" , id:"location"},
    {name:"Kinh nghiệm", icon:IconBriefcase, value:"Expert", id:"experience"},
    {name:"Mức lương", icon:IconPremiumRights, value:"48 USD", id:"packageOffered"},
    {name:"Hình thức", icon:IconRecharging, value:"Full Time", id:"jobType"},
]
